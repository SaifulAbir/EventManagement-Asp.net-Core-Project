...
namespace EventManagement.Concrete
{
    public class FlowerConcrete : IFlower
    {
        ...
        public IQueryable<FlowerViewModel> ShowFlower(string sortColumn, string sortColumnDir, string Search)
        {
            var IQueryableFlower = (from tempflower in _context.Flower
                                       select new FlowerViewModel
                                       {
                                           FlowerID = tempflower.FlowerID,
                                           FlowerName = tempflower.FlowerName,
                                           FlowerCost = tempflower.FlowerCost,
                                           Createdate = tempflower.Createdate.Value.ToString("dd/MM/yyyy")
                                       });
