...
namespace EventManagement.Concrete
{
    public class EquipmentConcrete : IEquipment
    {
        ...
        public IQueryable<EquipmentViewModel> ShowEquipment(string sortColumn, string sortColumnDir, string Search)
        {
            var IQueryableEquipment = (from tempequ in _context.Equipment
                                   select new EquipmentViewModel
                                   {
                                       EquipmentID = tempequ.EquipmentID,
                                       EquipmentName = tempequ.EquipmentName,
                                       EquipmentCost = tempequ.EquipmentCost,
                                       Createdate = tempequ.Createdate.Value.ToString("dd/MM/yyyy")
                                   });
